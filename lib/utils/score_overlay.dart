...
import 'package:physiotherapy/widgets/score_overlay_widgets/error_syncing_widget.dart';
import 'package:physiotherapy/widgets/score_overlay_widgets/score_syncing_widget.dart';
...
import 'total_accuracy_painter.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Opacity(
                        ...
                        child: Text(
                          'you have successfully completed the ${_currentPose.title} ',
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 24.0,
                            letterSpacing: 1,
